...
A identificação da velocidade insegura de acordo com a hierarquia das vias foi realizado com base nos dados geográficos de eixos de vias disponibilizados pelo Instituto de Pesquisa e Planejamento Urbano de Curitiba @eixo_rua_sirgas.

= RESULTADOS

Ao total, a amostra do NDS-BR utilizada nesse trabalho apresentou uma quantidade de 40 condutores, que performaram #trips_total viagens entre 2019 e 2023. Isso totalizou uma quantidade de #horas_total horas de condução e uma distância de #dist_total quilômetros percorridos. Filtrando os pontos com velocidade acima de 0 km/h, essa amostra foi reduzida para #horas_filtrado horas de condução e uma distância de #dist_filtrado quilômetros percorridos. Em relação aos condutores, houve uma quantidade exata de participantes do sexo masculino e feminino, com idades variando entre #drivers_idade_min e #drivers_idade_max anos. Quatro condutores exerciam atividade remunerada em seus veículos. O tempo de habilitação dos participantes variou entre #drivers_license_min e #drivers_license_max anos.
